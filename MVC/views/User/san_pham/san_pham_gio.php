...
<body>
    ...
    <?php
         ...
         if($all>0){
            echo '
            <h1 class=" mt-24">Số sản phẩm có để đặt giờ này là '.$all.' Sản Phẩm </h1>
            ';
         }
        else{
           
          
            echo ' <h1 class=" mt-16">Xin lỗi khung giờ này chưa có xe để đặt <br> <a href="index.php" >quay lại <a/>  </h1>';
         }
