...
function themMoiXe()
{
    if (isset($_POST['btn_them'])) {
      ...
      $ma_gio = $_POST['ma_gio'];
      if($ten_xe != '' && $don_gia != '' && $ma_loai != '' &&  $_FILES['hinh']['name'] != '' && $thong_tin !='' && $giam_gia != '' && $so_km != '' && $xuat_xu != '' && $slots != '' && $dong_co != '' && $ma_gio !='' &&  $_FILES['hinh1']['name'] != '' &&  $_FILES['hinh2']['name'] != '' &&  $_FILES['hinh3']['name'] != ''){
        $sql = "INSERT INTO  xe(ten_xe,don_gia,ma_loai,hinh,thong_tin,giam_gia,so_km,xuat_xu,slots,dong_co,ma_gio,hinh1,hinh2,hinh3) VALUES ('$ten_xe','$don_gia','$ma_loai','$hinh','$thong_tin','$giam_gia','$so_km','$xuat_xu','$slots','$dong_co','$ma_gio','$hinh1' , '$hinh2' , '$hinh3')";       
        $conn = getConnect();
...
function suaXe(){
    if (isset($_POST['btn_sua'])) {
      ...
      $ma_gio = $_POST['ma_gio'];
        ...
        $sql = "UPDATE xe SET ten_xe = '$ten_xe' , don_gia='$don_gia',ma_loai='$ma_loai',hinh='$hinh',hinh1='$hinh1',hinh2='$hinh2',hinh3='$hinh3',thong_tin='$thong_tin',giam_gia='$giam_gia',so_km='$so_km',xuat_xu='$xuat_xu',slots='$slots',dong_co='$dong_co',ma_gio='$ma_gio' WHERE ma_xe = $ma_xe";       
        $conn = getConnect();
        $statement = $conn->prepare($sql);
        $statement->execute();
        move_uploaded_file($_FILES["hinh"]["tmp_name"], 'assets/images/img_data/' . $_FILES["hinh"]["name"]);
