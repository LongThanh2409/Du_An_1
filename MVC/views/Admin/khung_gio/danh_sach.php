...
<head>
  ...
  <link rel="stylesheet" href="assets/css/loai_xe.css" />
...
<body>
  ...
  <div class="header">
    ...
    <div class="main_content">
      <div class="banner">
        <span class="text">>> DANH SÁCH KHUNG GIỜ </span>
      ...
      <table style="max-width: 1140px; width: 100%;" >
        <tr class="tr1">
          <td class="td1">MÃ GIỜ</td>
          <td class="td2">KHUNG GIỜ</td>
        
        </tr>
        <?php foreach ($ds_kg as $key => $value) : ?>
          <tr class="tr2">
            <td class=""> <?= $value['ma_gio'] ?> </td>
