                        ...
                        <div class="card">
                            <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Nhập Tên Loại" name="ten_loai" value="<?php  if($ct['trang_thai'] == 1){
                                            echo 'Đã Duyệt';
                                         } ?>" readonly>
                                ...
                                <div class="border-top " >
                                    ...
                                    <a style="color: wheat;"  name="btn_delete" class="delete" href="index2.php?url=xoa_dang_ky_1&ma_dat=<?php echo $value['ma_dat'] ?>" onclick="return confirm('Xác nhận xóa ?')">
