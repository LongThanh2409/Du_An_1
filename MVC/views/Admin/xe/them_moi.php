  ...
  <body>
    ...
    <div class="header">
      ...
      <div class="main_content">
        ...
        <input type="text" name="ten_xe" class="ten_xe">
        <h3 class="h3">ĐƠN GIÁ</h3>
        <input type="text" name="don_gia" class="don_gia">
        ...
        <h3 class="h3">HÌNH ẢNH </h3>
         ...
         <input type="text" name="thong_tin" class="thong_tin">
          </div>
          <div class="right">
            <h3 class="h3">GIẢM GIÁ</h3>
            <input type="text" name="giam_gia" class="giam_gia">
            <h3 class="h3">SỐ KM</h3>
            <input type="text" name="so_km" class="so_km">
            <h3 class="h3">XUẤT XỨ</h3>
            <input type="text" name="xuat_xu" class="xuat_xu">
            <h3 class="h3">SLOTS</h3>
            <input type="text" name="slots" class="slots">
            <h3 class="h3">ĐỘNG CƠ</h3>
            <input type="text" name="dong_co" class="dong_co">
