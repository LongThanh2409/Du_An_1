    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-lg-2.5 col-xlg-3 m-auto">
            <a href="index2.php">
          ...
          <div class="col-md-6 col-lg-2.5 col-xlg-3 ">
            <a href="index2.php?url=ds_loai_xe">
            <div class="card card-hover">
              <div class="box bg-danger text-center">
                <h1 class="font-light text-white"><i class="mdi mdi-receipt"></i></h1>
                <h6 class="text-white">LOẠI XE</h6>
              </div>
            </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-2.5 col-xlg-3">
            <a href="index2.php?url=ds_khach_hang">
            <div class="card card-hover">
          ...
          <div class="col-md-6 col-lg-2.5 col-xlg-3">
          <a href="index2.php?url=ds_xe">
            <div class="card card-hover">
              <div class="box bg-warning text-center">
                <h1 class="font-light text-white"><i class="fa-solid fa-car"></i></h1>
                <h6 class="text-white">XE</h6>
              </div>
            </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-2.5 col-xlg-3">
          <a href="index2.php?url=ds_dang_ky_0">
            <div class="card card-hover">
              <div class="box bg-success text-center">
                <h1 class="font-light text-white"><i class="mdi mdi-calendar-check"></i></h1>
                <h6 class="text-white">ĐẶT LỊCH</h6>
              </div>
            </div>
            </a>
          </div>
